    ...
    <div class="relative max-w-4xl mx-auto">
        ...
        <div class="relative mb-8 bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 rounded-2xl overflow-hidden shadow-2xl p-8">
            ...
            <div class="relative flex items-center gap-6">
                <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/30 transform rotate-3 shrink-0">
                ...
                <div>
                    ...
                    <p class="text-indigo-200 text-sm max-w-xl leading-relaxed opacity-90">
                        Agregando sesión al curso: <span class="text-amber-400 font-semibold">{{ $curso->cur_nombre }}</span>
                    </p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('admin.programs.store') }}" method="POST" class="p-6 sm:p-8">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="pro_inicia">
                                Fecha de Inicio <span class="text-amber-500">*</span>
                            </label>
                            <input type="date" name="pro_inicia" id="pro_inicia"
                                value="{{ old('pro_inicia') }}"
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="pro_finaliza">
                                Fecha de Término
                            </label>
                            <input type="date" name="pro_finaliza" id="pro_finaliza"
                                value="{{ old('pro_finaliza') }}"
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:bg-white text-slate-700 font-medium transition-all shadow-sm">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="pro_hora_inicio">
                                Hora de Inicio
                            </label>
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="pro_hora_termino">
                                Hora de Término
                            </label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="pro_lugar">
                                Lugar
                            </label>
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="pro_cupos">
                                Cupos
                            </label>
                            <input type="number" name="pro_cupos" id="pro_cupos"
                                value="{{ old('pro_cupos', 30) }}" min="1"
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:bg-white text-slate-700 font-medium transition-all shadow-sm">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="rel_login">
                                Relator
                            </label>
                            <div class="relative">
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700 uppercase tracking-wide" for="pro_colaboradores">
                                Colaboradores
                            </label>
