    ...
    <div class="login-card w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative z-10">
        ...
        <div class="relative bg-gradient-to-b from-blue-950 to-blue-900 py-8 text-center">
            ...
            <div class="flex flex-col items-center mb-4">
                ...
                <h1 class="text-xl font-semibold text-white">Sistema SPD</h1>
                <p class="text-amber-300/80 text-sm mt-0.5">Perfeccionamiento Docente</p>
            </div>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    <label class="block text-slate-600 text-sm font-medium mb-2" for="adm_login">
                        Usuario
                    </label>
                    <input
                        class="input-glow w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:border-blue-900 focus:bg-white transition-all duration-300 @error('adm_login') border-red-400 bg-red-50 @enderror"
                        id="adm_login" type="text" name="adm_login" value="{{ old('adm_login') }}" required autofocus
            ...
            <div class="mt-8 pt-6 border-t border-slate-100 relative z-20">
                <p class="text-sm text-center text-slate-500 mb-3">¿Eres Estudiante?</p>
                <a href="{{ route('participant.login') }}"
                    class="block w-full text-center py-2.5 px-4 rounded-lg border-2 border-blue-900 text-blue-900 font-medium hover:bg-blue-50 transition-colors duration-300">
                    Ir al Portal del Participante
                </a>
            </div>
        </div>
